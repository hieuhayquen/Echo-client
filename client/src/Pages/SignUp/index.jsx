...
import logo from "../../images/Echo-black.png";
		...
		<div className={styles.container}>
			...
			<form onSubmit={handleSubmit} className={styles.form_container}>
				...
				<div className={styles.checkbox_container}>
					<Checkbox
						required={true}
						label="Share my registration data with Echo's content providers for marketing purposes."
					/>
				</div>
				<p className={styles.terms_condition}>
					By clicking on sign-up, you agree to Echo's{" "}
					<a href="/#">Terms and Conditions of Use.</a>
				</p>
				<p className={styles.terms_condition}>
					To learn more about how Echo collects, uses, shares and protects
					your personal data, please see{" "}
					<a href="/#">Echo's Privacy Policy.</a>
				</p>
